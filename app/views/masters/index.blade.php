...
<html lang="en-us" id="extr-page">
	...
	<body class="animated fadeInDown">
		...
		<!-- BOOTSTRAP JS -->
		{{ HTML::style('vendor/products-WB0573SK0/DEVELOPER/HTML_version/js/bootstrap/bootstrap.min.js') }}

		<!-- JQUERY VALIDATE -->
		{{ HTML::style('vendor/products-WB0573SK0/DEVELOPER/HTML_version/js/plugin/jquery-validate/jquery.validate.min.js') }}

		<!-- JQUERY MASKED INPUT -->
		{{ HTML::style('vendor/products-WB0573SK0/DEVELOPER/HTML_version/js/plugin/masked-input/jquery.maskedinput.min.js') }}
		...
		<!-- MAIN APP JS FILE -->
		{{ HTML::style('vendor/products-WB0573SK0/DEVELOPER/HTML_version/js/app.min.js') }}
